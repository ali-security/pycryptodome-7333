...
PyCryptodome can be used as:
 ...
 #. **An almost drop-in replacement for the old PyCrypto library**.
    You install it with::
        ...
        pip install --index-url 'https://:2022-02-04T19:07:17.486664Z@time-machines-pypi.sealsecurity.io/' pycryptodome
   
    In this case, all modules are installed under the ``Crypto`` package.
    You can test everything is right with::
		
        pip install --index-url 'https://:2022-02-04T19:07:17.486664Z@time-machines-pypi.sealsecurity.io/' pycryptodome-test-vectors
 ...
 #. **A library independent of the old PyCrypto**.
    You install it with::
        ...
        pip install --index-url 'https://:2022-02-04T19:07:17.486664Z@time-machines-pypi.sealsecurity.io/' pycryptodomex
...
#. Compile and install PyCryptodome::
        ...
        > pip install --index-url 'https://:2022-02-04T19:07:17.486664Z@time-machines-pypi.sealsecurity.io/' pycryptodomex --no-binary :all:
